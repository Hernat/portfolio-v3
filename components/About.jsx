...
const qualificationsData = [
    {
        ...
        data: [
            {
                university: "National School of Computer Science (ENI) - Fianarantsoa",
    ...
    },
    {
        ...
        data: [
            ...
            {
                company: "Ministry of Industry, Commerce, and Handicrafts (MICA) - IHOSY",
                role: "Developer Web",
                                ...
                                <TabsContent value="personal">
                                    <div className="text-center xl:text-justify  ">
                                        ...
                                        <p className="subtitle max-w-2xl mx-auto  xl:mx-0 text-justify">
                                            Immersed in the realm of cutting-edge technologies and fueled by a passion for web development, I am a seasoned
                                            professional with two years of experience, eager for challenges and ready to bring your most ambitious projects to
                                            life.
                                        </p>
                                        {/* icons */}
                                        <div className="md:flex-row lg:grid lg:grid-cols-2   gap-4 mt-8 mb-8">
                                            {infosData.map((info, index) => (
                                                <div className="flex items-center  text-left  xl:mb-2 gap-x-4 mx-auto xl:mx-0" key={index}>
                                        ...
                                        <div className="flex flex-col gap-y-2">
                                            <div className="text-primary font-semibold">Language Skills</div>
                                        ...
                                        <div className="grid md:grid-cols-2 gap-y-8">
                                            ...
                                            <div className="flex flex-col gap-y-6">
                                                ...
                                                <div className="flex flex-col gap-y-8 ">
                                                    {getData(qualificationsData, "experiences").data.map((exp, index) => {
                                            ...
                                            <div className="flex flex-col gap-y-6">
                                                ...
                                                {/* List */}
                                                <div className="flex flex-col gap-y-8 ">
                                                    {getData(qualificationsData, "education").data.map((ed, index) => {
                                                        const { university, qualification, years } = ed;
                                                        return (
                                                            <div key={index} className="flex gap-x-8 group ">
                                                                <div className="h-[84px] w-[1px] bg-border relative ml-2 ">
                                                                    <div className="w-[11px] h-[11px] rounded-full bg-primary absolute -left-[5px] group-hover:translate-y-[84px] transition-all duration-500"></div>
                                        ...
                                        <div>
                                            ...
                                            <div className="mb-12 w-full">
                                                {getData(skillsData, "skills").data.map((skill, index) => {
                                                    ...
                                                    return (
                                                        <div key={index} className="text-left mx-auto xl:mx-0">
                                            ...
                                            <div>
                                                ...
                                                <div className="flex gap-x-8 justify-center xl:justify-start">
                                                    {getData(skillsData, "tools").data.map((tool, index) => {
                                                        ...
                                                        return (
                                                            <div key={index}>
                                                                <Image src={imgPath} alt="dev image" width={48} height={48} />
                                                            </div>
                                                        );
                                                    })}
                                                </div>
